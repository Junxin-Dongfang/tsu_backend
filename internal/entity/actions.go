...
var ActionWhere = struct {
	...
	ActionCode:         whereHelperstring{field: "\"actions\".\"action_code\""},
	ActionName:         whereHelperstring{field: "\"actions\".\"action_name\""},
	ActionCategoryID:   whereHelpernull_String{field: "\"actions\".\"action_category_id\""},
	ActionType:         whereHelperstring{field: "\"actions\".\"action_type\""},
	RelatedSkillID:     whereHelpernull_String{field: "\"actions\".\"related_skill_id\""},
	FeatureTags:        whereHelpertypes_StringArray{field: "\"actions\".\"feature_tags\""},
	RangeConfig:        whereHelpertypes_JSON{field: "\"actions\".\"range_config\""},
	TargetConfig:       whereHelpernull_JSON{field: "\"actions\".\"target_config\""},
	AreaConfig:         whereHelpernull_JSON{field: "\"actions\".\"area_config\""},
	ActionPointCost:    whereHelpernull_Int{field: "\"actions\".\"action_point_cost\""},
	ManaCost:           whereHelpernull_Int{field: "\"actions\".\"mana_cost\""},
	ManaCostFormula:    whereHelpernull_String{field: "\"actions\".\"mana_cost_formula\""},
	CooldownTurns:      whereHelpernull_Int{field: "\"actions\".\"cooldown_turns\""},
	UsesPerBattle:      whereHelpernull_Int{field: "\"actions\".\"uses_per_battle\""},
	HitRateConfig:      whereHelpernull_JSON{field: "\"actions\".\"hit_rate_config\""},
	LegacyEffectConfig: whereHelpernull_JSON{field: "\"actions\".\"legacy_effect_config\""},
	Requirements:       whereHelpernull_JSON{field: "\"actions\".\"requirements\""},
	StartFlags:         whereHelpertypes_StringArray{field: "\"actions\".\"start_flags\""},
	AnimationConfig:    whereHelpernull_JSON{field: "\"actions\".\"animation_config\""},
	VisualEffects:      whereHelpernull_JSON{field: "\"actions\".\"visual_effects\""},
	SoundEffects:       whereHelpernull_JSON{field: "\"actions\".\"sound_effects\""},
	Description:        whereHelpernull_String{field: "\"actions\".\"description\""},
	IsActive:           whereHelpernull_Bool{field: "\"actions\".\"is_active\""},
	CreatedAt:          whereHelpernull_Time{field: "\"actions\".\"created_at\""},
	UpdatedAt:          whereHelpernull_Time{field: "\"actions\".\"updated_at\""},
	DeletedAt:          whereHelpernull_Time{field: "\"actions\".\"deleted_at\""},
}
...
func (q actionQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Action, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "entity: failed to execute a one query for actions")
	}
...
func (q actionQuery) All(ctx context.Context, exec boil.ContextExecutor) (ActionSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "entity: failed to assign all query results to Action slice")
	}
...
func (q actionQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "entity: failed to count actions rows")
	}
...
func (q actionQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "entity: failed to check if actions exists")
	}
...
func (o *Action) ActionEffects(mods ...qm.QueryMod) actionEffectQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"action_effects\".\"action_id\"=?", o.ID),
	)
...
func (o *Action) SkillUnlockActions(mods ...qm.QueryMod) skillUnlockActionQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"skill_unlock_actions\".\"action_id\"=?", o.ID),
	)
...
func (actionL) LoadActionCategory(ctx context.Context, e boil.ContextExecutor, singular bool, maybeAction interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`action_categories`),
		qm.WhereIn(`action_categories.id in ?`, argsSlice...),
		qmhelper.WhereIsNull(`action_categories.deleted_at`),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (actionL) LoadActionEffects(ctx context.Context, e boil.ContextExecutor, singular bool, maybeAction interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		...
		qm.WhereIn(`action_effects.action_id in ?`, argsSlice...),
...
func (actionL) LoadSkillUnlockActions(ctx context.Context, e boil.ContextExecutor, singular bool, maybeAction interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		...
		qm.WhereIn(`skill_unlock_actions.action_id in ?`, argsSlice...),
...
func Actions(mods ...qm.QueryMod) actionQuery {
	mods = append(mods, qm.From("\"actions\""), qmhelper.WhereIsNull("\"actions\".\"deleted_at\""))
	q := NewQuery(mods...)
...
func FindAction(ctx context.Context, exec boil.ContextExecutor, iD string, selectCols ...string) (*Action, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"actions\" where \"id\"=$1 and \"deleted_at\" is null", sel,
	)
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "entity: unable to select from actions")
	}
...
func (o *Action) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("entity: no actions provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "entity: unable to insert into actions")
	}
...
func (o *Action) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("entity: unable to update actions, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to update actions row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entity: failed to get rows affected by update for actions")
	}
...
func (q actionQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to update all for actions")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to retrieve rows affected for actions")
	}
...
func (o ActionSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to update all in action slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to retrieve rows affected all in update all action")
	}
	return rowsAff, nil
}
...
func (o *Action) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	if o == nil {
		return errors.New("entity: no actions provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("entity: unable to upsert actions, could not build update column list")
		}
		...
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(actionPrimaryKeyColumns) == 0 {
				return errors.New("entity: unable to upsert actions, could not build conflict column list")
			}
	...
	if err != nil {
		return errors.Wrap(err, "entity: unable to upsert actions")
	}
...
func (o *Action) Delete(ctx context.Context, exec boil.ContextExecutor, hardDelete bool) (int64, error) {
	if o == nil {
		return 0, errors.New("entity: no Action provided for delete")
	}
	...
	if hardDelete {
		...
		sql = fmt.Sprintf("UPDATE \"actions\" SET %s WHERE \"id\"=$2",
			strmangle.SetParamNames("\"", "\"", 1, wl),
		)
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to delete from actions")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entity: failed to get rows affected by delete for actions")
	}
...
func (q actionQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor, hardDelete bool) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("entity: no actionQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to delete all from actions")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entity: failed to get rows affected by deleteall for actions")
	}
...
func (o ActionSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor, hardDelete bool) (int64, error) {
	...
	if hardDelete {
		...
		wl := []string{"deleted_at"}
		sql = fmt.Sprintf("UPDATE \"actions\" SET %s WHERE "+
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to delete all from action slice")
	}
...
func (o *Action) ReloadG(ctx context.Context) error {
	if o == nil {
		return errors.New("entity: no Action provided for reload")
	}
...
func (o *ActionSlice) ReloadAllG(ctx context.Context) error {
	if o == nil {
		return errors.New("entity: empty ActionSlice provided for reload all")
	}
...
func (o *ActionSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "entity: unable to reload all in ActionSlice")
	}
...
func ActionExists(ctx context.Context, exec boil.ContextExecutor, iD string) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"actions\" where \"id\"=$1 and \"deleted_at\" is null limit 1)"
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "entity: unable to check if actions exists")
	}
