...
type User struct {
	...
	LastLoginIP null.String `boil:"last_login_ip" json:"last_login_ip,omitempty" toml:"last_login_ip" yaml:"last_login_ip,omitempty"`
...
var UserTableColumns = struct {
	...
	LastLoginIP: "users.last_login_ip",
...
var UserWhere = struct {
	...
	LastLoginIP whereHelpernull_String
	...
	Username:    whereHelperstring{field: "\"auth\".\"users\".\"username\""},
	Nickname:    whereHelpernull_String{field: "\"auth\".\"users\".\"nickname\""},
	Email:       whereHelperstring{field: "\"auth\".\"users\".\"email\""},
	PhoneNumber: whereHelpernull_String{field: "\"auth\".\"users\".\"phone_number\""},
	IsBanned:    whereHelperbool{field: "\"auth\".\"users\".\"is_banned\""},
	BanUntil:    whereHelpernull_Time{field: "\"auth\".\"users\".\"ban_until\""},
	BanReason:   whereHelpernull_String{field: "\"auth\".\"users\".\"ban_reason\""},
	AvatarURL:   whereHelpernull_String{field: "\"auth\".\"users\".\"avatar_url\""},
	Bio:         whereHelpernull_String{field: "\"auth\".\"users\".\"bio\""},
	BirthDate:   whereHelpernull_Time{field: "\"auth\".\"users\".\"birth_date\""},
	Gender:      whereHelpernull_String{field: "\"auth\".\"users\".\"gender\""},
	Timezone:    whereHelpernull_String{field: "\"auth\".\"users\".\"timezone\""},
	Language:    whereHelpernull_String{field: "\"auth\".\"users\".\"language\""},
	LastLoginAt: whereHelpernull_Time{field: "\"auth\".\"users\".\"last_login_at\""},
	LastLoginIP: whereHelpernull_String{field: "\"auth\".\"users\".\"last_login_ip\""},
	LoginCount:  whereHelperint{field: "\"auth\".\"users\".\"login_count\""},
...
var UserRels = struct {
	GrantedByRolePermissions string
	UserLoginHistories       string
}{
	GrantedByRolePermissions: "GrantedByRolePermissions",
	UserLoginHistories:       "UserLoginHistories",
}

// userR is where relationships are stored.
type userR struct {
	GrantedByRolePermissions RolePermissionSlice   `boil:"GrantedByRolePermissions" json:"GrantedByRolePermissions" toml:"GrantedByRolePermissions" yaml:"GrantedByRolePermissions"`
...
func (o *User) GetGrantedByRolePermissions() RolePermissionSlice {
	if o == nil {
		return nil
	}

	return o.R.GetGrantedByRolePermissions()
}

func (r *userR) GetGrantedByRolePermissions() RolePermissionSlice {
	if r == nil {
		return nil
	}

	return r.GrantedByRolePermissions
}
...
func (o *User) GetUserLoginHistories() UserLoginHistorySlice {
	...
	return o.R.GetUserLoginHistories()
}

func (r *userR) GetUserLoginHistories() UserLoginHistorySlice {
	if r == nil {
		return nil
	}

	return r.UserLoginHistories
}
...
func (q userQuery) One(ctx context.Context, exec boil.ContextExecutor) (*User, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "auth: failed to execute a one query for users")
	}
...
func (q userQuery) All(ctx context.Context, exec boil.ContextExecutor) (UserSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "auth: failed to assign all query results to User slice")
	}
...
func (q userQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "auth: failed to count users rows")
	}
...
func (q userQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "auth: failed to check if users exists")
	}

	return count > 0, nil
}

// GrantedByRolePermissions retrieves all the role_permission's RolePermissions with an executor via granted_by column.
func (o *User) GrantedByRolePermissions(mods ...qm.QueryMod) rolePermissionQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"auth\".\"role_permissions\".\"granted_by\"=?", o.ID),
	)
...
func (o *User) UserLoginHistories(mods ...qm.QueryMod) userLoginHistoryQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"auth\".\"user_login_history\".\"user_id\"=?", o.ID),
	)

	return UserLoginHistories(queryMods...)
}

// LoadGrantedByRolePermissions allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadGrantedByRolePermissions(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		...
		qm.WhereIn(`auth.role_permissions.granted_by in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if singular {
		object.R.GrantedByRolePermissions = resultSlice
		for _, foreign := range resultSlice {
			if foreign.R == nil {
				foreign.R = &rolePermissionR{}
			}
			foreign.R.GrantedByUser = object
		}
		return nil
	}
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if queries.Equal(local.ID, foreign.GrantedBy) {
				local.R.GrantedByRolePermissions = append(local.R.GrantedByRolePermissions, foreign)
				if foreign.R == nil {
					foreign.R = &rolePermissionR{}
				}
				foreign.R.GrantedByUser = local
				break
			}
		}
	}
...
// LoadUserLoginHistories allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadUserLoginHistories(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		qm.From(`auth.user_login_history`),
		qm.WhereIn(`auth.user_login_history.user_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	results, err := query.QueryContext(ctx, e)
	if err != nil {
		return errors.Wrap(err, "failed to eager load user_login_history")
	}

	var resultSlice []*UserLoginHistory
	if err = queries.Bind(results, &resultSlice); err != nil {
		return errors.Wrap(err, "failed to bind eager loaded slice user_login_history")
	}

	if err = results.Close(); err != nil {
		return errors.Wrap(err, "failed to close results in eager load on user_login_history")
	}
	if err = results.Err(); err != nil {
		return errors.Wrap(err, "error occurred during iteration of eager loaded relations for user_login_history")
	}
	...
	if singular {
		object.R.UserLoginHistories = resultSlice
		for _, foreign := range resultSlice {
			if foreign.R == nil {
				foreign.R = &userLoginHistoryR{}
			}
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.ID == foreign.UserID {
				local.R.UserLoginHistories = append(local.R.UserLoginHistories, foreign)
				if foreign.R == nil {
					foreign.R = &userLoginHistoryR{}
				}
...
// AddGrantedByRolePermissionsG adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.GrantedByRolePermissions.
// Sets related.R.GrantedByUser appropriately.
// Uses the global database handle.
func (o *User) AddGrantedByRolePermissionsG(ctx context.Context, insert bool, related ...*RolePermission) error {
	return o.AddGrantedByRolePermissions(ctx, boil.GetContextDB(), insert, related...)
}

// AddGrantedByRolePermissionsP adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.GrantedByRolePermissions.
// Sets related.R.GrantedByUser appropriately.
// Panics on error.
func (o *User) AddGrantedByRolePermissionsP(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*RolePermission) {
	if err := o.AddGrantedByRolePermissions(ctx, exec, insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}

// AddGrantedByRolePermissionsGP adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.GrantedByRolePermissions.
// Sets related.R.GrantedByUser appropriately.
// Uses the global database handle and panics on error.
func (o *User) AddGrantedByRolePermissionsGP(ctx context.Context, insert bool, related ...*RolePermission) {
	if err := o.AddGrantedByRolePermissions(ctx, boil.GetContextDB(), insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}

// AddGrantedByRolePermissions adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.GrantedByRolePermissions.
// Sets related.R.GrantedByUser appropriately.
func (o *User) AddGrantedByRolePermissions(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*RolePermission) error {
	var err error
	for _, rel := range related {
		if insert {
			queries.Assign(&rel.GrantedBy, o.ID)
	...
	if o.R == nil {
		o.R = &userR{
			GrantedByRolePermissions: related,
		}
	} else {
		o.R.GrantedByRolePermissions = append(o.R.GrantedByRolePermissions, related...)
	}
...
// SetGrantedByRolePermissionsG removes all previously related items of the
// user replacing them completely with the passed
// in related items, optionally inserting them as new records.
// Sets o.R.GrantedByUser's GrantedByRolePermissions accordingly.
// Replaces o.R.GrantedByRolePermissions with related.
// Sets related.R.GrantedByUser's GrantedByRolePermissions accordingly.
// Uses the global database handle.
func (o *User) SetGrantedByRolePermissionsG(ctx context.Context, insert bool, related ...*RolePermission) error {
	return o.SetGrantedByRolePermissions(ctx, boil.GetContextDB(), insert, related...)
}

// SetGrantedByRolePermissionsP removes all previously related items of the
// user replacing them completely with the passed
// in related items, optionally inserting them as new records.
// Sets o.R.GrantedByUser's GrantedByRolePermissions accordingly.
// Replaces o.R.GrantedByRolePermissions with related.
// Sets related.R.GrantedByUser's GrantedByRolePermissions accordingly.
// Panics on error.
func (o *User) SetGrantedByRolePermissionsP(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*RolePermission) {
	if err := o.SetGrantedByRolePermissions(ctx, exec, insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}

// SetGrantedByRolePermissionsGP removes all previously related items of the
// user replacing them completely with the passed
// in related items, optionally inserting them as new records.
// Sets o.R.GrantedByUser's GrantedByRolePermissions accordingly.
// Replaces o.R.GrantedByRolePermissions with related.
// Sets related.R.GrantedByUser's GrantedByRolePermissions accordingly.
// Uses the global database handle and panics on error.
func (o *User) SetGrantedByRolePermissionsGP(ctx context.Context, insert bool, related ...*RolePermission) {
	if err := o.SetGrantedByRolePermissions(ctx, boil.GetContextDB(), insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}

// SetGrantedByRolePermissions removes all previously related items of the
// user replacing them completely with the passed
// in related items, optionally inserting them as new records.
// Sets o.R.GrantedByUser's GrantedByRolePermissions accordingly.
// Replaces o.R.GrantedByRolePermissions with related.
// Sets related.R.GrantedByUser's GrantedByRolePermissions accordingly.
func (o *User) SetGrantedByRolePermissions(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*RolePermission) error {
	query := "update \"auth\".\"role_permissions\" set \"granted_by\" = null where \"granted_by\" = $1"
	...
	if o.R != nil {
		for _, rel := range o.R.GrantedByRolePermissions {
			queries.SetScanner(&rel.GrantedBy, nil)
			if rel.R == nil {
				continue
			}

			rel.R.GrantedByUser = nil
		}
		o.R.GrantedByRolePermissions = nil
	}

	return o.AddGrantedByRolePermissions(ctx, exec, insert, related...)
}

// RemoveGrantedByRolePermissionsG relationships from objects passed in.
// Removes related items from R.GrantedByRolePermissions (uses pointer comparison, removal does not keep order)
// Sets related.R.GrantedByUser.
// Uses the global database handle.
func (o *User) RemoveGrantedByRolePermissionsG(ctx context.Context, related ...*RolePermission) error {
	return o.RemoveGrantedByRolePermissions(ctx, boil.GetContextDB(), related...)
}

// RemoveGrantedByRolePermissionsP relationships from objects passed in.
// Removes related items from R.GrantedByRolePermissions (uses pointer comparison, removal does not keep order)
// Sets related.R.GrantedByUser.
// Panics on error.
func (o *User) RemoveGrantedByRolePermissionsP(ctx context.Context, exec boil.ContextExecutor, related ...*RolePermission) {
	if err := o.RemoveGrantedByRolePermissions(ctx, exec, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}

// RemoveGrantedByRolePermissionsGP relationships from objects passed in.
// Removes related items from R.GrantedByRolePermissions (uses pointer comparison, removal does not keep order)
// Sets related.R.GrantedByUser.
// Uses the global database handle and panics on error.
func (o *User) RemoveGrantedByRolePermissionsGP(ctx context.Context, related ...*RolePermission) {
	if err := o.RemoveGrantedByRolePermissions(ctx, boil.GetContextDB(), related...); err != nil {
		panic(boil.WrapErr(err))
	}
}

// RemoveGrantedByRolePermissions relationships from objects passed in.
// Removes related items from R.GrantedByRolePermissions (uses pointer comparison, removal does not keep order)
// Sets related.R.GrantedByUser.
func (o *User) RemoveGrantedByRolePermissions(ctx context.Context, exec boil.ContextExecutor, related ...*RolePermission) error {
	if len(related) == 0 {
		return nil
	}
	...
	for _, rel := range related {
		...
		if _, err = rel.Update(ctx, exec, boil.Whitelist("granted_by")); err != nil {
			return err
		}
	}
	if o.R == nil {
	...
	for _, rel := range related {
		for i, ri := range o.R.GrantedByRolePermissions {
			if rel != ri {
				continue
			}

			ln := len(o.R.GrantedByRolePermissions)
			if ln > 1 && i < ln-1 {
				o.R.GrantedByRolePermissions[i] = o.R.GrantedByRolePermissions[ln-1]
			}
			o.R.GrantedByRolePermissions = o.R.GrantedByRolePermissions[:ln-1]
			break
		}
	}
...
// Appends related to o.R.UserLoginHistories.
// Sets related.R.User appropriately.
func (o *User) AddUserLoginHistories(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*UserLoginHistory) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.UserID = o.ID
	...
	if o.R == nil {
		o.R = &userR{
			UserLoginHistories: related,
		}
	} else {
		o.R.UserLoginHistories = append(o.R.UserLoginHistories, related...)
	}

	for _, rel := range related {
		if rel.R == nil {
			rel.R = &userLoginHistoryR{
				User: o,
			}
		} else {
			rel.R.User = o
...
func Users(mods ...qm.QueryMod) userQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"auth\".\"users\".*"})
	}
...
func FindUser(ctx context.Context, exec boil.ContextExecutor, iD string, selectCols ...string) (*User, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "auth: unable to select from users")
	}
...
func (o *User) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("auth: no users provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "auth: unable to insert into users")
	}
...
func (o *User) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("auth: unable to update users, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "auth: unable to update users row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "auth: failed to get rows affected by update for users")
	}
...
func (q userQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "auth: unable to update all for users")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "auth: unable to retrieve rows affected for users")
	}
...
func (o UserSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "auth: unable to update all in user slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "auth: unable to retrieve rows affected all in update all user")
	}
	return rowsAff, nil
}
...
func (o *User) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	if o == nil {
		return errors.New("auth: no users provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("auth: unable to upsert users, could not build update column list")
		}
		...
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(userPrimaryKeyColumns) == 0 {
				return errors.New("auth: unable to upsert users, could not build conflict column list")
			}

			conflict = make([]string, len(userPrimaryKeyColumns))
			copy(conflict, userPrimaryKeyColumns)
		}
		cache.query = buildUpsertQueryPostgres(dialect, "\"auth\".\"users\"", updateOnConflict, ret, update, conflict, insert, opts...)
	...
	if err != nil {
		return errors.Wrap(err, "auth: unable to upsert users")
	}
...
func (o *User) Delete(ctx context.Context, exec boil.ContextExecutor, hardDelete bool) (int64, error) {
	if o == nil {
		return 0, errors.New("auth: no User provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "auth: unable to delete from users")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "auth: failed to get rows affected by delete for users")
	}
...
func (q userQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor, hardDelete bool) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("auth: no userQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "auth: unable to delete all from users")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "auth: failed to get rows affected by deleteall for users")
	}
...
func (o UserSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor, hardDelete bool) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "auth: unable to delete all from user slice")
	}
...
func (o *User) ReloadG(ctx context.Context) error {
	if o == nil {
		return errors.New("auth: no User provided for reload")
	}
...
func (o *UserSlice) ReloadAllG(ctx context.Context) error {
	if o == nil {
		return errors.New("auth: empty UserSlice provided for reload all")
	}
...
func (o *UserSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "auth: unable to reload all in UserSlice")
	}
...
func UserExists(ctx context.Context, exec boil.ContextExecutor, iD string) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "auth: unable to check if users exists")
	}
