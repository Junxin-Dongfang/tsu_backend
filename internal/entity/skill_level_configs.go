...
var SkillLevelConfigWhere = struct {
	...
	ID:                whereHelperstring{field: "\"skill_level_configs\".\"id\""},
	SkillID:           whereHelperstring{field: "\"skill_level_configs\".\"skill_id\""},
	LevelNumber:       whereHelperint{field: "\"skill_level_configs\".\"level_number\""},
	DamageMultiplier:  whereHelpertypes_NullDecimal{field: "\"skill_level_configs\".\"damage_multiplier\""},
	HealingMultiplier: whereHelpertypes_NullDecimal{field: "\"skill_level_configs\".\"healing_multiplier\""},
	DurationModifier:  whereHelpernull_Int{field: "\"skill_level_configs\".\"duration_modifier\""},
	RangeModifier:     whereHelpernull_Int{field: "\"skill_level_configs\".\"range_modifier\""},
	CooldownModifier:  whereHelpernull_Int{field: "\"skill_level_configs\".\"cooldown_modifier\""},
	ManaCostModifier:  whereHelpernull_Int{field: "\"skill_level_configs\".\"mana_cost_modifier\""},
	EffectModifiers:   whereHelpernull_JSON{field: "\"skill_level_configs\".\"effect_modifiers\""},
	UpgradeCostXP:     whereHelpernull_Int{field: "\"skill_level_configs\".\"upgrade_cost_xp\""},
	UpgradeCostGold:   whereHelpernull_Int{field: "\"skill_level_configs\".\"upgrade_cost_gold\""},
	UpgradeMaterials:  whereHelpernull_JSON{field: "\"skill_level_configs\".\"upgrade_materials\""},
	CreatedAt:         whereHelpernull_Time{field: "\"skill_level_configs\".\"created_at\""},
	UpdatedAt:         whereHelpernull_Time{field: "\"skill_level_configs\".\"updated_at\""},
	DeletedAt:         whereHelpernull_Time{field: "\"skill_level_configs\".\"deleted_at\""},
}
...
func (q skillLevelConfigQuery) One(ctx context.Context, exec boil.ContextExecutor) (*SkillLevelConfig, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "entity: failed to execute a one query for skill_level_configs")
	}
...
func (q skillLevelConfigQuery) All(ctx context.Context, exec boil.ContextExecutor) (SkillLevelConfigSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "entity: failed to assign all query results to SkillLevelConfig slice")
	}
...
func (q skillLevelConfigQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "entity: failed to count skill_level_configs rows")
	}
...
func (q skillLevelConfigQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "entity: failed to check if skill_level_configs exists")
	}
...
func SkillLevelConfigs(mods ...qm.QueryMod) skillLevelConfigQuery {
	mods = append(mods, qm.From("\"skill_level_configs\""), qmhelper.WhereIsNull("\"skill_level_configs\".\"deleted_at\""))
	q := NewQuery(mods...)
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"skill_level_configs\".*"})
	}
...
func FindSkillLevelConfig(ctx context.Context, exec boil.ContextExecutor, iD string, selectCols ...string) (*SkillLevelConfig, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"skill_level_configs\" where \"id\"=$1 and \"deleted_at\" is null", sel,
	)
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "entity: unable to select from skill_level_configs")
	}
...
func (o *SkillLevelConfig) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("entity: no skill_level_configs provided for insertion")
	}
	...
	if !cached {
		...
		if len(wl) != 0 {
			cache.query = fmt.Sprintf("INSERT INTO \"skill_level_configs\" (\"%s\") %%sVALUES (%s)%%s", strings.Join(wl, "\",\""), strmangle.Placeholders(dialect.UseIndexPlaceholders, len(wl), 1, 1))
		} else {
			cache.query = "INSERT INTO \"skill_level_configs\" %sDEFAULT VALUES%s"
		}
	...
	if err != nil {
		return errors.Wrap(err, "entity: unable to insert into skill_level_configs")
	}
...
func (o *SkillLevelConfig) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("entity: unable to update skill_level_configs, could not build whitelist")
		}

		cache.query = fmt.Sprintf("UPDATE \"skill_level_configs\" SET %s WHERE %s",
	...
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to update skill_level_configs row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entity: failed to get rows affected by update for skill_level_configs")
	}
...
func (q skillLevelConfigQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to update all for skill_level_configs")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to retrieve rows affected for skill_level_configs")
	}
...
func (o SkillLevelConfigSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	sql := fmt.Sprintf("UPDATE \"skill_level_configs\" SET %s WHERE %s",
	...
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to update all in skillLevelConfig slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to retrieve rows affected all in update all skillLevelConfig")
	}
	return rowsAff, nil
}
...
func (o *SkillLevelConfig) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	if o == nil {
		return errors.New("entity: no skill_level_configs provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("entity: unable to upsert skill_level_configs, could not build update column list")
		}
		...
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(skillLevelConfigPrimaryKeyColumns) == 0 {
				return errors.New("entity: unable to upsert skill_level_configs, could not build conflict column list")
			}

			conflict = make([]string, len(skillLevelConfigPrimaryKeyColumns))
			copy(conflict, skillLevelConfigPrimaryKeyColumns)
		}
		cache.query = buildUpsertQueryPostgres(dialect, "\"skill_level_configs\"", updateOnConflict, ret, update, conflict, insert, opts...)
	...
	if err != nil {
		return errors.Wrap(err, "entity: unable to upsert skill_level_configs")
	}
...
func (o *SkillLevelConfig) Delete(ctx context.Context, exec boil.ContextExecutor, hardDelete bool) (int64, error) {
	if o == nil {
		return 0, errors.New("entity: no SkillLevelConfig provided for delete")
	}
	...
	if hardDelete {
		...
		sql = "DELETE FROM \"skill_level_configs\" WHERE \"id\"=$1"
	} else {
		currTime := time.Now().In(boil.GetLocation())
		o.DeletedAt = null.TimeFrom(currTime)
		wl := []string{"deleted_at"}
		sql = fmt.Sprintf("UPDATE \"skill_level_configs\" SET %s WHERE \"id\"=$2",
			strmangle.SetParamNames("\"", "\"", 1, wl),
		)
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to delete from skill_level_configs")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entity: failed to get rows affected by delete for skill_level_configs")
	}
...
func (q skillLevelConfigQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor, hardDelete bool) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("entity: no skillLevelConfigQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to delete all from skill_level_configs")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entity: failed to get rows affected by deleteall for skill_level_configs")
	}
...
func (o SkillLevelConfigSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor, hardDelete bool) (int64, error) {
	...
	if hardDelete {
		...
		sql = "DELETE FROM \"skill_level_configs\" WHERE " +
		...
		wl := []string{"deleted_at"}
		sql = fmt.Sprintf("UPDATE \"skill_level_configs\" SET %s WHERE "+
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to delete all from skillLevelConfig slice")
	}
...
func (o *SkillLevelConfig) ReloadG(ctx context.Context) error {
	if o == nil {
		return errors.New("entity: no SkillLevelConfig provided for reload")
	}
...
func (o *SkillLevelConfigSlice) ReloadAllG(ctx context.Context) error {
	if o == nil {
		return errors.New("entity: empty SkillLevelConfigSlice provided for reload all")
	}
...
func (o *SkillLevelConfigSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	sql := "SELECT \"skill_level_configs\".* FROM \"skill_level_configs\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 1, skillLevelConfigPrimaryKeyColumns, len(*o)) +
	...
	if err != nil {
		return errors.Wrap(err, "entity: unable to reload all in SkillLevelConfigSlice")
	}
...
func SkillLevelConfigExists(ctx context.Context, exec boil.ContextExecutor, iD string) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"skill_level_configs\" where \"id\"=$1 and \"deleted_at\" is null limit 1)"
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "entity: unable to check if skill_level_configs exists")
	}
