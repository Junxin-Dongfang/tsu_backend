...
var UserWhere = struct {
	...
	BanUntil:    whereHelpernull_Time{field: "\"users\".\"ban_until\""},
	BanReason:   whereHelpernull_String{field: "\"users\".\"ban_reason\""},
	...
	LastLoginIP: whereHelpernull_String{field: "\"users\".\"last_login_ip\""},
	LoginCount:  whereHelperint{field: "\"users\".\"login_count\""},
...
func (o *User) UserLoginHistories(mods ...qm.QueryMod) userLoginHistoryQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"user_login_history\".\"user_id\"=?", o.ID),
	)
...
func (userL) LoadUserLoginHistories(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`user_login_history`),
		qm.WhereIn(`user_login_history.user_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
