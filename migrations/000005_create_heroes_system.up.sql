...
CREATE TABLE IF NOT EXISTS heroes (
    ...
    -- 职业信息
    class_id          UUID NOT NULL REFERENCES classes(id) ON DELETE RESTRICT,-- 所属职业
...
CREATE INDEX IF NOT EXISTS idx_heroes_current_level ON heroes(current_level) WHERE deleted_at IS NULL;
